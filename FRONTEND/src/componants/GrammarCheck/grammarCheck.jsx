    ...
    return (
        <>
            ...
            <Box sx={{ display: "flex", height: "20vh", width: "70vw", alignSelf: "center", justifyContent: "center", flexDirection: "column", m: "auto", mt: 3, }}>
                <Button variant="text" sx={{ display: "flex", alignSelf: "start", margin: "10px", color: "text.secondary" }} onClick={() => navigat("/getStart")}
                ...
                <Typography sx={{ margin: "auto", fontSize: "17px", color: "text.secondary" }}>
                    Perfect your CV content with our advanced grammar and style checker</Typography>
            </Box>
            {/* Main Content Section */}
            <Box sx={{
                display: "flex", height: "60vh", width: "70vw", alignSelf: "center",
                flexDirection: "row", m: "auto", mt: 5, gap: 2, justifyContent: "space-between",
            }}>
                <Box sx={{ width: "60%" }}>
                    <TextField
                        multiline
                ...
                <Box sx={{ width: "35%", alignSelf: "flex-start", minHeight: "150px", bgcolor: "background.gray", borderRadius: "10px" }}>
